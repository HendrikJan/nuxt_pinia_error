...
import htmlTemplate from '/home/haaiee/Projects/Temp/nuxt_pinit_error/.nuxt/views/document.template.mjs';
import { createRenderer as createRenderer$1 } from 'vue-server-renderer/build.dev.js';

const _runtimeConfig = (function(a,b,c,d){return {public:{axios:{baseURL:c,browserBaseURL:c},_app:{basePath:a,assetsPath:b,cdnURL:d,buildAssetsDir:b,baseURL:a},app:{basePath:a,assetsPath:b,cdnURL:d,buildAssetsDir:b,baseURL:a}},private:{}}}("\u002F","\u002F_nuxt\u002F","http:\u002F\u002Flocalhost:3000",null));
...
const _3c5a47 = () => Promise.resolve().then(function () { return www; });

  const middleware = [
    { route: '/', handle: _3c5a47, lazy: true, promisify: true }
  ];
...
app$1.use(timingMiddleware);
app$1.use(middleware);
app$1.use(() => Promise.resolve().then(function () { return render; }).then((e) => e.renderMiddleware), { lazy: true });
app$1.stack;
const handle = useBase(baseURL(), app$1);
...
const www = /*#__PURE__*/Object.freeze({
  __proto__: null,
  'default': app
});

const STATIC_ASSETS_BASE = "/_nuxt/static" + "/" + "1643708087";
const PAYLOAD_JS = "/payload.js";
const getClientManifest = cachedImport(() => import('/home/haaiee/Projects/Temp/nuxt_pinit_error/.nuxt/dist/server/client.manifest.mjs'));
const getSSRApp = cachedImport(() => import('/home/haaiee/Projects/Temp/nuxt_pinit_error/.nuxt/dist/server/server.mjs'));
